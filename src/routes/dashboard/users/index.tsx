...
import { CreateUserModal } from '../../../modals/auth/create-user-modal'
import { getUserTypeInfo, getAvailableUserTypes } from '../../../lib/user-types-config'
import { 
  Users, 
  Search, 
  Plus,
...
function UsersPage() {
  ...
  const buildApiUrl = (page: number, search: string) => {
    ...
    // Use search endpoint if search term or any filters are provided
    const hasFilters = search.trim() || filters.user_type || filters.name || filters.email || filters.user_name
    const endpoint = hasFilters ? '/auth/users/search' : '/auth/users'
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <CardTitle className="text-2xl flex items-center gap-2">
                  ...
                  {(searchTerm || filters.user_type || filters.name || filters.email || filters.user_name || filters.orderBy !== 'created_at') && (
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  Filters
                  {(filters.user_type || filters.name || filters.email || filters.user_name || filters.orderBy !== 'created_at') && (
            ...
            <CardContent className="pt-0">
              <div className="border-t pt-4">
                <div className="space-y-4">
                  {/* Search Filters */}
                  <div>
                    <Label className="text-sm font-medium mb-3 block">Search Filters</Label>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="email_filter">Email</Label>
                        <Input
                          id="email_filter"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="username_filter">Username</Label>
                        <Input
                          id="username_filter"
                  ...
                  <div>
                    <Label className="text-sm font-medium mb-3 block">Category & Sorting</Label>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          {availableUserTypes.map((type: any) => (
                      ...
                      <TableRow key={userData.id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Dialog
                              open={deleteDialog.open && deleteDialog.userId === userData.id}
                              onOpenChange={(open) => {
                                if (!open) {
                                  setDeleteDialog({ open: false, userId: '', userName: '' })
                                }
                              ...
                              <DialogTrigger asChild>
                                <Button
                                  ...
                                  onClick={() => setDeleteDialog({
                                    open: true,
                                    userId: userData.id,
                                    userName: `${userData.name} ${userData.last_name}`.trim() || userData.email
                                  })}
                                  disabled={loading}
                                >
